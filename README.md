...
# Download
[Ultima versione](https://github.com/FedericoBoccaccioPersonale/Speciali-Catomi-IA/releases/latest) (tutte le piattaforme disponibili)

Con somma fatica sono riuscito a caricare il progetto in Github pages, quindi puoi [🌐 Eseguire on line](https://federicoboccacciopersonale.github.io/Speciali-Catomi-IA/) una versione funzionante (salvo che per la gestione dei file)
